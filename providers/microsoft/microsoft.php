...
class NextendSocialPROProviderMicrosoft extends NextendSocialProvider {
    ...
    public function __construct() {
        ...
        $this->hasRedirectRESTRoute = true;
    ...
    public function getRedirectUriForApp() {
        ...
        return rest_url('/nextend-social-login/v1/microsoft/redirect_uri');
    ...
    public function getClient() {
        if ($this->client === null) {
            ...
            $this->client->setRedirectUri($this->getRedirectUriForApp());

            if ($tenant !== 'consumers') {
                //This scope is required to get data from users with work/school accounts, however the "consumers" endpoints don't support it.
                $this->client->addScope('User.Read');
            }
